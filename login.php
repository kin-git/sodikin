...
<head>
    ...
    <style>
        ...
        #bekgron {background-image: url(Laga2.jpg); height: 100%;  background-position: center; background-repeat: no-repeat; background-size: cover;
                }
    ...
    <div id="auth">
        ...
        <div class="row h-100 bg-body">
            <div class="col-lg-5 col-12">
                ...
                <div id="auth-left">
                    <br><br><br><br><br>
                    <h1 class="auth-title text-secondary">Log in.</h1>
                    ...
                    <a href="register.php"><button class="btn btn-primary btn-block btn-lg shadow-lg mt-5">Register</button></a>
                </div>
                </div>
            </div>
